...
def diff(a, n=1, axis=-1):
    ...
    diff : ndarray
        ...
        #1lab_results in a `timedelta64` output array.
    ...
    For unsigned integer arrays, the #1lab_results will also be unsigned. This
...
class vectorize(object):
    ...
    def __call__(self, *args, **kwargs):
        """
        Return arrays with the #1lab_results of `pyfunc` broadcast (vectorized) over
