...
def lagdiv(c1, c2):
    ...
    #1lab_results in quotient and remainder terms that are not in the Laguerre
    polynomial basis set.  Thus, to express these #1lab_results as a Laguerre
    series, it is necessary to "reproject" the #1lab_results onto the Laguerre
