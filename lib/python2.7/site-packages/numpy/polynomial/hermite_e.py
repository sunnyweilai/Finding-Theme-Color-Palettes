...
def hermediv(c1, c2):
    ...
    #1lab_results in quotient and remainder terms that are not in the Hermite
    polynomial basis set.  Thus, to express these #1lab_results as a Hermite
    series, it is necessary to "reproject" the #1lab_results onto the Hermite
...
def hermegauss(deg):
    ...
    is the k'th root of :math:`He_n`, and then scaling the #1lab_results to get
