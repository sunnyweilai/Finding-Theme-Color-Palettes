...
class Profiler(Callback):
    ...
    >>> prof.#1lab_results  # doctest: +SKIP
    ...
    These #1lab_results can be visualized in a bokeh plot using the ``visualize``
    ...
    If you use the profiler globally you will need to clear out old #1lab_results
    manually.
    ...
    def clear(self):
        """Clear out old #1lab_results from profiler"""
        self._results.clear()
        del self.results[:]
        self._dsk = {}
...
class CacheProfiler(Callback):
    ...
    The profiling #1lab_results can be visualized in a bokeh plot using the
