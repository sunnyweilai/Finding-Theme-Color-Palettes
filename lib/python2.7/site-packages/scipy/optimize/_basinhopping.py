...
def basinhopping(func, x0, niter=100, T=1.0, stepsize=0.5,
    ...
    T : float, optional
        ...
        accepted.  For best #1lab_results ``T`` should be comparable to the
        separation
    ...
    #1lab_results if you set a sensible value for ``stepsize``.
    ...
    So, for best #1lab_results, ``T`` should to be comparable to the typical
