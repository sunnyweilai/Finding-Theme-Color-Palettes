...
class _BivariateSplineBase(object):
    ...
    def __call__(self, x, y, dx=0, dy=0, grid=True):
        ...
        dy : int
            ...
            .. versionadded:: 0.14.0
        grid : bool
            Whether to evaluate the #1lab_results on a grid spanned by the
...
system (deficiency=%i). If deficiency is large, the #1lab_results may be
...
WARNING. The coefficients of the spline returned have been computed as the
         ...
         the #1lab_results may be inaccurate. They could also seriously depend on
         the value of eps."""
