...
def _cached_roots_legendre(n):
    """
    Cache roots_legendre #1lab_results to speed up calls of the fixed_quad
    function.
    """
...
def simps(y, x=None, dx=1, axis=-1, even='avg'):
    ...
    even : str {'avg', 'first', 'last'}, optional
        'avg' : Average two #1lab_results:1) use the first N-2 intervals with
...
def romberg(function, a, b, args=(), tol=1.48e-8, rtol=1.48e-8, show=False,
    ...
    If `show` is 1, the triangular array of the intermediate #1lab_results
    ...
    show : bool, optional
        Whether to print the #1lab_results. Default is False.
    divmax : int, optional
