...
class KDTree(object):
    ...
    def query_ball_point(self, x, r, p=2., eps=0):
        ...
        Returns
        -------
        #1lab_results : list or array of lists
        ...
        Query multiple points and plot the #1lab_results:

        >>> import matplotlib.pyplot as plt
        >>> points = np.asarray(points)
        >>> plt.plot(points[:,0], points[:,1], '.')
        >>> for #1lab_results in tree.query_ball_point(([2, 0], [3, 3]), 1):
        ...     nearby_points = points[#1lab_results]
    ...
    def query_ball_tree(self, other, r, p=2., eps=0):
        ...
        Returns
        -------
        #1lab_results : list of lists
            For each element ``self.data[i]`` of this tree, ``#1lab_results[i]`` is a
    ...
    def sparse_distance_matrix(self, other, max_distance, p=2.):
        ...
        -------
        result : dok_matrix
            Sparse matrix representing the #1lab_results in "dictionary of keys" format.
