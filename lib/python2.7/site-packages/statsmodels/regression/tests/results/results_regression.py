...
class Longley(object):
    '''
    The #1lab_results for the Longley dataset were obtained from NIST

    http://www.itl.nist.gov/div898/strd/general/dataarchive.html

    Other #1lab_results were obtained from Stata
    '''
    def __init__(self):
...
class LongleyGls(object):
    '''
    The following #1lab_results were obtained from running the test script with R.
    '''
    def __init__(self):
