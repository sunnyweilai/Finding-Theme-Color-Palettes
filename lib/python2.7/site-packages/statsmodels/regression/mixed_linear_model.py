...
class MixedLM(base.LikelihoodModel):
    ...
    def fit_regularized(self, start_params=None, method='l1', alpha=0,
        ...
        Returns
        -------
        A MixedLMResults instance containing the #1lab_results.
    ...
    def fit(self, start_params=None, reml=True, niter_sa=0,
        ...
        free : MixedLMParams object
            ...
            work).
        full_output : bool
            If true, attach iteration history to #1lab_results
        method : string
            Optimization method.
...
class MixedLMResults(base.LikelihoodModelResults, base.ResultMixin):
    '''
    Class to contain #1lab_results of fitting a linear mixed effects model.
    ...
    **Attributes**
    ...
    def summary(self, yname=None, xname_fe=None, xname_re=None,
                title=None, alpha=.05):
        """
        Summarize the mixed model regression #1lab_results.
