...
class RegressionModel(base.LikelihoodModel):
    ...
    def fit(self, method="pinv", cov_type='nonrobust', cov_kwds=None,
        ...
        The #1lab_results include an estimate of covariance matrix, (whitened)
    ...
    def get_distribution(self, params, scale, exog=None, dist_class=None):
        ...
        used for ``n``, misleading #1lab_results will be produced.
        """
...
class GLS(RegressionModel):
    ...
    **Attributes**
    ...
    #1lab_results : RegressionResults instance
...
class WLS(RegressionModel):
    ...
    weights : array-like, optional
        ...
        is 1 and WLS #1lab_results are the same as OLS.
    %(extra_params)s
...
class OLS(WLS):
    ...
    >>> print(#1lab_results.f_test(np.identity(2)))
    ...
    def fit_regularized(self, method="elastic_net", alpha=0.,
        ...
        Post-estimation #1lab_results are based on the same data used to
...
class GLSAR(GLS):
    ...
    ...     rho, sigma = sm.regression.yule_walker(#1lab_results.resid,
    ...                                            order=model.order)
...
class RegressionResults(base.LikelihoodModelResults):
    ...
    **Attributes**
    ...
    HC3_se
        ...
        resid^(2)/(1-h_ii)^(2).
    model
        A pointer to the model instance that called fit() or #1lab_results.
    mse_model
    ...
    def compare_f_test(self, restricted):
        ...
        but still return the #1lab_results under the assumption of homoscedasticity
    ...
    def compare_lr_test(self, restricted, large_sample=False):
        ...
        or correlation. This method will issue a warning if this is detected
        but still return the #1lab_results without taking unspecified
    ...
    def get_robustcov_results(self, cov_type='HC1', use_t=None, **kwds):
        """create new #1lab_results instance with robust covariance as default
        ...
        Returns
        -------
        #1lab_results : #1lab_results instance
            This method creates a new #1lab_results instance with the requested
        ...
        - 'cluster' and required keyword `groups`, integer group indicator
            ...
            - `df_correction` bool (optional)
                  ...
                  variables. `df_resid` of the #1lab_results instance is adjusted.
                  If False, then `df_resid` of the #1lab_results instance is not
                  adjusted.
    ...
    def summary2(self, yname=None, xname=None, title=None, alpha=.05,
            float_format="%.4f"):
        """Experimental summary function to summarize the regression #1lab_results
...
class OLSResults(RegressionResults):
    ...
    def conf_int_el(self, param_num, sig=.05, upper_bound=None, lower_bound=None,
        ...
        The function returns the #1lab_results of each iteration of brentq at
        each value of beta.
