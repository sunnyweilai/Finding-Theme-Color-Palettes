...
def load_data(fname, icept=True):
    """
    Load a data set from the #1lab_results directory.  The data set should
    ...
    Z = np.genfromtxt(os.path.join(cur_dir, '#1lab_results', fname),
                      delimiter=",")
...
class TestGEE(object):
    ...
    def test_poisson_epil(self):
        ...
        cur_dir = os.path.dirname(os.path.abspath(__file__))
        fname = os.path.join(cur_dir, "#1lab_results", "epil.csv")
    ...
    def test_equivalence(self):
        ...
        #1lab_results are identical using the two approaches.
        """
