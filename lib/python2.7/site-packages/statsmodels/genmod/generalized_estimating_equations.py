...
class GEE(base.Model):
    ...
    def _covmat(self):
        ...
        cmat : array-like
           ...
           obtaining score test #1lab_results.
        """
...
class GEEResults(base.LikelihoodModelResults):
    ...
    def summary(self, yname=None, xname=None, title=None, alpha=.05):
        """
        Summarize the GEE regression #1lab_results
...
class GEEMargins(object):
    ...
    results : GEEResults instance
        The #1lab_results instance of a fitted discrete choice model
    args : tuple
        Args are passed to `get_margeff`. This is the same as
        #1lab_results.get_margeff. See there for more information.
    kwargs : dict
