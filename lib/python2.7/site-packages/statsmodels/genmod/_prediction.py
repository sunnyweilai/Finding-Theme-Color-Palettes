...
def get_prediction_glm(self, exog=None, transform=True, weights=None,
    ...
    """
    compute prediction #1lab_results
    ...
    prediction_results : instance
        The prediction #1lab_results instance contains prediction and prediction
...
def params_transform_univariate(params, cov_params, link=None, transform=None,
                     row_labels=None):
    """
    #1lab_results for univariate, nonlinear, monotonicaly transformed parameters
