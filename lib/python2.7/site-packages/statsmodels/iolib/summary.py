...
def summary(self, yname=None, xname=None, title=0, alpha=.05,
    ...
    Default :
    returns='print'
            Prints the summarirized #1lab_results
    ...
    Option :
    returns='csv'
            returns a string of csv of the #1lab_results, to import into a spreadsheet
    ...
    >>> ols_results = sm.OLS(data.endog, data.exog).#1lab_results
...
def summary_params_2d(result, extras=None, endog_names=None, exog_names=None,
    ...
    table_all : SimpleTable
        the merged table with #1lab_results concatenated for each row of the parameter
        array
