...
class Summary(object):
    ...
    def add_title(self, title=None, results=None):
        ...
        provided but a #1lab_results instance is provided, statsmodels attempts
    ...
    def add_base(self, results, alpha=0.05, float_format="%.4f", title=None,
        ...
        Parameters
        ----------
        results : Model #1lab_results instance
        alpha : float
...
def summary_params(results, yname=None, xname=None, alpha=.05, use_t=True,
    ...
    '''create a summary table of parameters from #1lab_results instance

    Parameters
    ----------
    res : #1lab_results instance
...
def summary_col(results, float_format='%.4f', model_names=[], stars=False,
    ...
    """
    Summarize multiple #1lab_results instances side-by-side (coefs and SEs)

    Parameters
    ----------
    results : statsmodels #1lab_results instance or list of result instances
    float_format : string
        float format for coefficients and standard errors
        Default : '%.4f'
    model_names : list of strings of length len(#1lab_results) if the names are not
        unique, a roman number will be appended to all model names
    stars : bool
        print significance stars
    info_dict : dict
        dict of lambda functions to be applied to #1lab_results instances to retrieve
        model info. To use specific information for different models, add a
        (nested) info_dict with model name as the key.
        Example: `info_dict = {"N":..., "R2": ..., "OLS":{"R2":...}}` would
        only show `R2` for OLS regression models, but additionally `N` for
        all other #1lab_results.
