...
##   qwb = xlrd.open_workbook('F:/lab_10/bioinformatics/qcrittable.xls')
...
class TukeyHSDResults(object):
    ...
    def plot_simultaneous(self, comparison_name=None, ax=None, figsize=(10,6),
        ...
        >>> #1lab_results = cardata.tukeyhsd()
        >>> #1lab_results.plot_simultaneous()
        ...
        >>> #1lab_results.plot_simultaneous(comparison_name="USA")
        <matplotlib.figure.Figure at 0x...>
...
class MultiComparison(object):
    ...
    group_order : list of strings, optional
        the desired order for the group mean #1lab_results to be reported in. If
        not specified, #1lab_results are reported in increasing order.
    ...
    def allpairtest(self, testfunc, alpha=0.05, method='bonf', pvalidx=1):
        ...
        #1lab_results from multipletests are in different order
    ...
    def tukeyhsd(self, alpha=0.05):
        ...
        Returns
        -------
        #1lab_results : TukeyHSDResults instance
            A #1lab_results class containing relevant data and some post-hoc
            calculations
        """
