...
class IV2SLS(LikelihoodModel):
    ...
    def fit(self):
        ...
        Returns
        -------
        #1lab_results : instance of RegressionResults
           regression result
        ...
        Parameter estimates and covariance are correct, but other #1lab_results
...
class GMM(Model):
    ...
    -------
    *Attributes*
    #1lab_results : instance of GMMResults
...
#         self.instrument = instrument
    ...
    def fit(self, start_params=None, maxiter=10, inv_weights=None,
        ...
        -------
        #1lab_results : instance of GMMResults
            this is also attached as attribute #1lab_results
        ...
        See options for cov_params in the #1lab_results instance.
...
class DistQuantilesGMM(GMM):
    ...
    def fitonce(self, start=None, weights=None, has_optimal_weights=False):
        '''fit without estimating an optimal weighting matrix and return #1lab_results
        ...
        Returns
        -------
        #1lab_results : GMMResult instance
