...
>>> #1lab_results = mice.fit(10, 10)
>>> print(#1lab_results.summary())
...
Examples
--------
Run all MICE steps and obtain #1lab_results:
%(mice_example_1)s
...
%(mice_example_2)s
    ...
    def combine(self):
        """
        Pools MICE imputation #1lab_results.
