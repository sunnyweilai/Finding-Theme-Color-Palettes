...
class CheckModelResults(object):
    """
    res2 should be the test #1lab_results from RModelWrap
    or the #1lab_results as defined in model_results_data
    """
...
class CheckLikelihoodModelL1(object):
    """
    For testing #1lab_results generated with L1 regularization
    """
    def test_params(self):
        assert_almost_equal(self.res1.params, self.res2.params, DECIMAL_4)
...
class CompareL1(object):
    """
    For checking #1lab_results for l1 regularization.
...
class CompareL11D(CompareL1):
    """
    Check t and f tests.  This only works for 1-d #1lab_results
    """
    def test_tests(self):
...
class TestPoissonNewton(CheckModelResults):
    ...
    def test_predict_prob(self):
        ...
        probs_res = np.loadtxt(os.path.join(cur_dir, "#1lab_results",
...
class TestNegativeBinomialGeometricBFGS(CheckModelResults):
    """
    Cannot find another implementation of the geometric to cross-check #1lab_results
...
def test_perfect_prediction():
    cur_dir = os.path.dirname(os.path.abspath(__file__))
    iris_dir = os.path.join(cur_dir, '..', '..', 'genmod', 'tests', '#1lab_results')
...
def test_issue_339():
    ...
    cur_dir = os.path.dirname(os.path.abspath(__file__))
    test_case_file = os.path.join(cur_dir, '#1lab_results', 'mn_logit_summary.txt')
