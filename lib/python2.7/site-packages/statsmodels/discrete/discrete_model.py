...
class DiscreteModel(base.LikelihoodModel):
    ...
    def _check_perfect_pred(self, params, *args):
        ...
        if (self.raise_on_perfect_prediction and
            ...
            msg = "Perfect separation detected, #1lab_results not available"
...
class BinaryModel(DiscreteModel):
    ...
    def _derivative_exog(self, params, exog=None, transform='dydx',
        ...
        but checks are done in the #1lab_results in get_margeff.
        """
...
%(params)s
    ...
    def fit_constrained(self, constraints, start_params=None, **fit_kwds):
        ...
        exog, and converts the #1lab_results back to the original parameterization.
...
class DiscreteResults(base.LikelihoodModelResults):
    ...
    def summary2(self, yname=None, xname=None, title=None, alpha=.05,
            float_format="%.4f"):
        """Experimental function to summarize regression #1lab_results
...
class CountResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {
                    "one_line_description" : "A #1lab_results class for count data",
                    "extra_attr" : ""}
    @cache_readonly
    def resid(self):
        """
...
class NegativeBinomialResults(CountResults):
    __doc__ = _discrete_results_docs % {
        "one_line_description" : "A #1lab_results class for NegativeBinomial 1 and 2",
                    "extra_attr" : ""}
...
class L1CountResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {"one_line_description" :
            "A #1lab_results class for count data fit by l1 regularization",
...
class OrderedResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {"one_line_description" : "A #1lab_results class for ordered discrete data." , "extra_attr" : ""}
    pass

class BinaryResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {"one_line_description" : "A #1lab_results class for binary data", "extra_attr" : ""}
    ...
    def summary(self, yname=None, xname=None, title=None, alpha=.05,
        ...
        if predclose_sum == len(fittedvalues): #nobs?
            wstr = "Complete Separation: The #1lab_results show that there is"
...
class LogitResults(BinaryResults):
    __doc__ = _discrete_results_docs % {
        "one_line_description" : "A #1lab_results class for Logit Model",
                    "extra_attr" : ""}
    @cache_readonly
...
class ProbitResults(BinaryResults):
    __doc__ = _discrete_results_docs % {
        "one_line_description" : "A #1lab_results class for Probit Model",
                    "extra_attr" : ""}
    @cache_readonly
    def resid_generalized(self):
        """
...
class MultinomialResults(DiscreteResults):
    __doc__ = _discrete_results_docs % {"one_line_description" :
            "A #1lab_results class for multinomial data", "extra_attr" : ""}
...
class L1MultinomialResults(MultinomialResults):
    __doc__ = _discrete_results_docs % {"one_line_description" :
        "A #1lab_results class for multinomial data fit by l1 regularization",
        "extra_attr" : _l1_results_attr}
...
# skipped for now, binary poisson lab_results look off?
