...
class ContrastResults(object):
    """
    Class for #1lab_results of tests of linear restrictions on coefficients in a model.
    ...
    def summary(self, xname=None, alpha=0.05, title=None):
        ...
        smry : string or Summary instance
            This contains a parameter #1lab_results table in the case of t or z test
            in the same form as the parameter #1lab_results table in the model
            #1lab_results summary.
