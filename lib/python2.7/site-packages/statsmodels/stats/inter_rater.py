...
def cohens_kappa(table, weights=None, return_results=True, wt=None):
    ...
    table : array_like, 2-Dim
        square array with #1lab_results of two raters, one rater in rows, second
        rater in columns
    weights : array_like
    ...
    Returns
    -------
    #1lab_results or kappa
        If return_results is True (default), then a #1lab_results instance with all
    ...
    of the weights matrix, so there is no difference in the #1lab_results.
