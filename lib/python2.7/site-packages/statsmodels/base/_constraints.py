...
def fit_constrained(model, constraint_matrix, constraint_values,
    ...
    **fit_kwds : keyword arguments
    ...
    cov_params : ndarray
        ...
        covariance.
    res_constr : #1lab_results instance
        This is the #1lab_results instance for the created transformed model.
...
def fit_constrained_wrap(model, constraints, start_params=None, **fit_kwds):
    """fit_constraint that returns a #1lab_results instance
    ...
    #1lab_results instance is not standardized for use outside the `fit` methods,
