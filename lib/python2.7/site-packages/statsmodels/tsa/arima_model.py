...
_predict_notes = """
        Notes
        -----
        Use the #1lab_results predict method instead.
"""
...
class ARMA(tsbase.TimeSeriesModel):
    ...
    def fit(self, start_params=None, trend='c', method="css-mle",
        ...
        ARMAResults : #1lab_results class returned by fit
...
class ARIMA(ARMA):
    ...
    def fit(self, start_params=None, trend='c', method="css-mle",
        ...
        statsmodels.base.model.LikelihoodModel.fit : for more information
            on using the solvers.
        ARIMAResults : #1lab_results class returned by fit
...
class ARMAResults(tsbase.TimeSeriesModelResults):
    """
    Class to hold #1lab_results from fitting an ARMA model.
