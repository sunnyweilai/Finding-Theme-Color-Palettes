...
var_path = '#1lab_results' + os.sep + 'results_var_stata.csv'
var_results = pd.read_csv(current_path + os.sep + var_path)

varmax_path = '#1lab_results' + os.sep + 'results_varmax_stata.csv'
...
class CheckFREDManufacturing(CheckVARMAX):
    ...
    def setup_class(cls, true, order, trend, error_cov_type, cov_type='approx',
        ...
        cls.true = true
        # 1960:Q1 - 1982:Q4
        with open(current_path + os.sep + '#1lab_results' + os.sep + 'manufac.dta', 'rb') as test_data:
