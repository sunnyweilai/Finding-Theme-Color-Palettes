...
class MLEModel(tsbase.TimeSeriesModel):
    ...
    **kwargs
    ...
    def set_smoother_output(self, smoother_output=None, **kwargs):
        ...
        The smoother can produce several types of #1lab_results. The smoother output
    ...
    def filter(self, params, transformed=True, complex_step=False,
        ...
        return_ssm : boolean,optional
            ...
            #1lab_results object. Default is to return a full #1lab_results object.
        cov_type : str, optional
            See `MLEResults.fit` for a description of covariance matrix types
            for #1lab_results object.
        cov_kwds : dict or None, optional
...
class MLEResults(tsbase.TimeSeriesModelResults):
    r"""
    Class to hold #1lab_results from fitting a state space model.
    ...
    scale : float
        This is currently set to 1.0 and not used by the model or its #1lab_results.
    ...
    def _get_robustcov_results(self, cov_type='opg', **kwargs):
        """
        Create new #1lab_results instance with specified covariance estimator as
        default

        Note: creating new #1lab_results instance currently not supported.
    ...
    def test_serial_correlation(self, method, lags=None):
        ...
        output : array
            ...
            holds the #1lab_results of the Ljung-Box test (as would be returned by
