    ...
    **kwargs
    ...
    def set_smoother_output(self, smoother_output=None, **kwargs):
        ...
        **kwargs
        ...
        SMOOTHER_ALL
            Calculate and return all #1lab_results.
        ...
        If performance is a concern, only those #1lab_results which are needed should
        be specified as any #1lab_results that are not specified will not be
    ...
    def smooth(self, smoother_output=None, results=None, run_filter=True,
        ...
        results : class or object, optional
            ...
            filtering and smoothing #1lab_results.
        ...
        if isinstance(results, type):
            if not issubclass(results, SmootherResults):
                raise ValueError('Invalid #1lab_results class provided.')
...
class SmootherResults(FilterResults):
    ...
    def update_smoother(self, smoother):
        """
        Update the smoother #1lab_results
