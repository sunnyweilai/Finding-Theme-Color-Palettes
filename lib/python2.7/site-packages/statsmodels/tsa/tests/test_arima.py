...
y_arma = np.genfromtxt(open(current_path + '/#1lab_results/y_arma_data.csv', "rb"),
...
class CheckArmaResultsMixin(object):
    """
    res2 are the #1lab_results from gretl.  They are in #1lab_results/results_arma.
...
def test_arima_predict_mle_dates():
    ...
    with open(current_path + '/#1lab_results/results_arima_forecasts_all_mle.csv', "rb") as test_data:
...
def test_arima_predict_css_dates():
    ...
    with open(current_path + '/#1lab_results/results_arima_forecasts_all_css.csv', "rb") as test_data:
        arima_forecasts = np.genfromtxt(test_data, delimiter=",", skip_header=1, dtype=float)
...
def test_arima_predict_css_diffs():
    ...
    with open(current_path + '/#1lab_results/results_arima_forecasts_all_css_diff.csv', "rb") as test_data:
        arima_forecasts = np.genfromtxt(test_data, delimiter=",", skip_header=1, dtype=float)
    fc = arima_forecasts[:,0]
    fcdyn = arima_forecasts[:,1]
    fcdyn2 = arima_forecasts[:,2]
...
def test_arima_predict_mle_diffs():
    ...
    with open(current_path + '/#1lab_results/results_arima_forecasts_all_mle_diff.csv', "rb") as test_data:
        arima_forecasts = np.genfromtxt(test_data, delimiter=",", skip_header=1, dtype=float)
    fc = arima_forecasts[:,0]
    fcdyn = arima_forecasts[:,1]
    fcdyn2 = arima_forecasts[:,2]
...
def test_arima_predict_exog():
    ...
    arima_forecasts = read_csv(current_path + "/#1lab_results/"
