...
def _autolag(mod, endog, exog, startlag, maxlag, method, modargs=(),
    ...
    """
    Returns the #1lab_results for the lag length that maximizes the info criterion.
    ...
    regresults : bool, optional
        Flag indicating to return optional return #1lab_results
    ...
    #1lab_results : dict, optional
        Dictionary containing all estimation #1lab_results
...
def adfuller(x, maxlag=None, regression="c", autolag='AIC',
    ...
    regresults : bool, optional
        If True, the full regression #1lab_results are returned. Default is False
    ...
    resstore : ResultStore, optional
        A dummy class with #1lab_results attached as attributes
...
def q_stat(x, nobs, type="ljungbox"):
    ...
    nobs : int
        ...
        of the autocorrelation function #1lab_results.
...
def levinson_durbin(s, nlags=10, isacov=False):
    ...
    Notes
    -----
    This function returns currently all #1lab_results, but maybe we drop sigma and
...
def grangercausalitytests(x, maxlag, addconst=True, verbose=True):
    ...
    all four tests give similar #1lab_results
    ...
    maxlag : integer
        the Granger causality test #1lab_results are calculated for all lags up to
        maxlag
    verbose : bool
        print #1lab_results if true

    Returns
    -------
    #1lab_results : dictionary
        all test #1lab_results, dictionary keys are the number of lags. For each
        lag the values are a tuple, with the first element a dictionary with
        teststatistic, pvalues, degrees of freedom, the second element are
        the OLS estimation #1lab_results for the restricted model, the unrestricted
        model and the restriction (contrast) matrix for the parameter f_test.

    Notes
    -----
    TODO: convert to class and attach #1lab_results properly
...
def coint(y0, y1, trend='c', method='aeg', maxlag=None, autolag='aic',
    ...
    return_results : bool
        ...
        If True, then a #1lab_results instance is returned. Otherwise, a tuple
...
def kpss(x, regression='c', lags=None, store=False):
    ...
    resstore : (optional) instance of ResultStore
        An instance of a dummy class with #1lab_results attached as attributes
