...
def write_generate_var():
    result = generate_var()
    np.savez('tests/#1lab_results/vars_results.npz', **result)

class RResults(object):
    """
    Simple interface with #1lab_results generated by "vars" package in R.
    """
...
resultspath = basepath + '/tsa/vector_ar/tests/#1lab_results/'
...
class TestVARResultsLutkepohl(object):
    """
    Verify calculations using #1lab_results from Lutkepohl's book
    """
