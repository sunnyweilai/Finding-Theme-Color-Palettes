...
def test_path_components():
    if sys.platform.startswith('linux'):
        path_components0 = ['','','documents','test','lab_vif.py']
    else:
        path_components0 = ['c:','','documents','test','lab_vif.py']
...
def test_differentiate_prefix():
    if sys.platform.startswith('linux'):
        path_components0 = ['','','documents','test','lab_vif.py']
        path_components1 = ['','','documents','projects','test','lab_vif.py']
    else:
        path_components0 = ['c:','','documents','test','lab_vif.py']
        path_components1 = ['c:','','documents','projects','test','lab_vif.py']
...
def test_get_same_name_files():
    ...
    if sys.platform.startswith('linux'):
        ...
        fname1 = os.path.join(*['','','documents','projects','test','lab_vif.py'])
        files_path_list.append(fname1)
        same_name_files = [['','','documents','test','lab_vif.py'],
                           ['','','documents','projects','test','lab_vif.py']]
    else:
        fname0 = os.path.join(*['c:','','documents','test','lab_vif.py'])
        files_path_list.append(fname0)
        fname1 = os.path.join(*['c:','','documents','projects','test','lab_vif.py'])
        files_path_list.append(fname1)
        same_name_files = [['c:','','documents','test','lab_vif.py'],
                           ['c:','','documents','projects','test','lab_vif.py']]
        assert sourcecode.get_same_name_files(files_path_list
                                              ,'lab_vif.py') == same_name_files

def test_shortest_path():
    if sys.platform.startswith('linux'):
        files_path_list =[['','','documents','test','lab_vif.py'],
                          ['','','documents','projects','test','lab_vif.py']]
        shortest_path = os.path.join(*['','','documents','test','lab_vif.py'])
    else:
        files_path_list =[['c:','','documents','test','lab_vif.py'],
                          ['c:','','documents','projects','test','lab_vif.py']]
        shortest_path = os.path.join(*['c:','','documents','test','lab_vif.py'])
