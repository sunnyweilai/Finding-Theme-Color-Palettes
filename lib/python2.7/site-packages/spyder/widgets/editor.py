...
class FileInfo(QObject):
    ...
    def set_analysis_results(self, results):
        """Set analysis #1lab_results and update warning markers in editor"""
        self.analysis_results = results
        self.editor.process_code_analysis(results)

    def cleanup_analysis_results(self):
        """Clean-up analysis #1lab_results"""
        self.analysis_results = []
...
#                                              5, menu_btn]}
    ...
    def set_analysis_results(self, filename, analysis_results):
        """Synchronize analysis #1lab_results between editorstacks"""
        index = self.has_filename(filename)
        if index is None:
            return
    ...
    def set_todo_results(self, filename, todo_results):
        """Synchronize todo #1lab_results between editorstacks"""
        index = self.has_filename(filename)
        if index is None:
            return
