...
class PageIterator(object):
    ...
    def search(self, expression):
        ...
        Each page of #1lab_results is searched using the provided JMESPath
...
class ResultKeyIterator(object):
    """Iterates over the #1lab_results of paginated responses.
    ...
    :param pages_iterator: An iterator that will give you
        pages of #1lab_results (a ``PageIterator`` class).
