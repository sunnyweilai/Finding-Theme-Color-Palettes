...
class MultiProcess(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option("--processes", action="store",
                          ...
                          "or cores in your machine for best #1lab_results. "
        ...
        parser.add_option("--process-timeout", action="store",
                          ...
                          metavar="SECONDS",
                          help="Set timeout for return of #1lab_results from each "
...
class MultiProcessTestRunner(TextTestRunner):
    ...
    def run(self, test):
        ...
        try:
            while tasks:
                log.debug("Waiting for #1lab_results (%s/%s tasks), next timeout=%.3fs",
            ...
            log.info('parent received ctrl-c when waiting for test #1lab_results')
            thrownError = e
