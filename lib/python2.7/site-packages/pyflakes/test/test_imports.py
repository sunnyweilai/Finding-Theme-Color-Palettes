...
class TestSpecialAll(TestCase):
    ...
    def test_usedInGenExp(self):
        """
        Using a global in a generator expression #1lab_results in no warnings.
        """
        self.flakes('import fu; (fu for _ in range(1))')
        self.flakes('import fu; (1 for _ in range(1) if fu)')
    ...
    def test_redefinedByGenExp(self):
        ...
        expression #1lab_results in a redefinition warning.
        """
        self.flakes('import fu; (1 for fu in range(1))',
                    m.RedefinedWhileUnused, m.UnusedImport)
    ...
    def test_usedAsDecorator(self):
        """
        Using a global name in a decorator statement #1lab_results in no warnings,
        but using an undefined name in a decorator statement #1lab_results in an
...
class Python26Tests(TestCase):
    ...
    def test_usedAsClassDecorator(self):
        """
        Using an imported name as a class decorator #1lab_results in no warnings,
        but using an undefined name as a class decorator #1lab_results in an
        undefined name warning.
        """
        self.flakes('''
        from interior import decorate
