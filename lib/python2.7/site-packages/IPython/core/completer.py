...
class Completer(Configurable):
    ...
    greedy = Bool(False,
        ...
        This will enable completion on elements of lists, #1lab_results of function calls, etc.,
...
class IPCompleter(Completer):
    ...
    merge_completions = Bool(True,
        help="""Whether to merge completion #1lab_results into a single list
        
        If False, only the completion #1lab_results from the first non-empty
