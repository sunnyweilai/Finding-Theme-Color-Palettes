...
python-profiler package from non-free.""")
    ...
    def prun(self, parameter_s='', cell=None):
        ...
        -T <filename>
          save profile #1lab_results as shown on screen to a text
    ...
    def run(self, parameter_s='', runner=None,
        ...
        *two* back slashes (e.g. ``\\\\*``) to suppress expansions.
        ...
        -e
          ...
          cases you are interested in the output of the test #1lab_results, not in
        ...
        run.  The final timing report will include total and per run #1lab_results.
    ...
    def timeit(self, line='', cell=None):
        ...
        does not matter as long as #1lab_results from timeit.py are not mixed with
        those from %timeit."""
