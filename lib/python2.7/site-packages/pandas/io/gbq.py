...
def read_gbq(query, project_id=None, index_col=None, col_order=None,
    ...
    and read #1lab_results into a pandas DataFrame.
    ...
    index_col : str (optional)
        Name of result column to use for index in #1lab_results DataFrame
    col_order : list(str) (optional)
        List of BigQuery column names in the desired order for #1lab_results
        DataFrame
    ...
    **kwargs : Arbitrary keyword arguments
    ...
    -------
    df: DataFrame
        DataFrame representing #1lab_results of query
