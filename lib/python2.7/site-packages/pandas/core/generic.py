...
class NDFrame(PandasObject, SelectionMixin):
    ...
    _shared_docs['where'] = ("""
        ...
        errors : str, {'raise', 'ignore'}, default 'raise'
            ...
            the #1lab_results and will always coerce to a suitable dtype.
    ...
    def describe(self, percentiles=None, include=None, exclude=None):
        ...
        include : 'all', list-like of dtypes or None (default), optional
            ...
            - A list-like of dtypes : Limits the #1lab_results to the
              provided data types.
        ...
        ``count`` and ``top`` #1lab_results will be arbitrarily chosen from
