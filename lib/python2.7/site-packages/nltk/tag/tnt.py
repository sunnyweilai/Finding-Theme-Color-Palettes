...
class TnT(TaggerI):
    ...
    * SHOULD BE USED WITH SENTENCE-DELIMITED INPUT
      ...
      - However it still produces good #1lab_results if the training
    ...
    * Function provided to process text that is unsegmented
    ...
    gain in the accuracy of the #1lab_results.
    '''
    ...
    def tagdata(self, data):
        ...
        compiles the #1lab_results into a list of tagged sentences
...
def basic_sent_chop(data, raw=True):
    ...
    tagger. Better sentence tokenization will further enhance the #1lab_results.
    '''
