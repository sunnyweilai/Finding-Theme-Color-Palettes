...
class BottomUpProbabilisticChartParser(ParserI):
    ...
    record partial #1lab_results.  ``BottomUpProbabilisticChartParser`` maintains
...
class InsideChartParser(BottomUpProbabilisticChartParser):
    ...
    *P(p)P(c[1])P(c[2])...P(c[n])*; and the inside
    ...
    This sorting order #1lab_results in a type of lowest-cost-first search
    strategy.
    """
    # Inherit constructor.
    def sort_queue(self, queue, chart):
...
class RandomChartParser(BottomUpProbabilisticChartParser):
    ...
    This sorting order #1lab_results in a random search strategy.
    """
    # Inherit constructor
    def sort_queue(self, queue, chart):
...
class LongestChartParser(BottomUpProbabilisticChartParser):
    ...
    shorter ones.  This sorting order #1lab_results in a type of best-first
    search strategy.
    """
    # Inherit constructor
    def sort_queue(self, queue, chart):
...
def demo(choice=None, draw_parses=None, print_parses=None):
    ...
    summary of the #1lab_results are displayed.
    """
    import sys, time
