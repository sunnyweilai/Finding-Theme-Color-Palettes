...
def read_po(fileobj, locale=None, domain=None, ignore_obsolete=False, charset=None):
    ...
    (u'foo %(name)s', u'quux %(name)s')
      ([(u'rgb_main.py', 1)], [u'fuzzy', u'python-format'])
      ([], [])
...
def write_po(fileobj, catalog, width=76, no_location=False, omit_header=False,
    ...
    >>> catalog = Catalog()
    >>> catalog.add(u'foo %(name)s', locations=[('rgb_main.py', 1)],
    ...             flags=('fuzzy',))
    <Message...>
    >>> catalog.add((u'bar', u'baz'), locations=[('rgb_main.py', 3)])
    <Message...>
