...
#1lab_results to XML files that can be consumed by a wide range of tools, such as
...
class _XMLTestResult(_TextTestResult):
    """A test result class that can express test #1lab_results in a XML report.
    ...
    def _get_info_by_testcase(self):
        """This method organizes test #1lab_results by TestCase module. This
...
class XMLTestRunner(TextTestRunner):
    """A test runner class that outputs the #1lab_results in JUnit like XML files.
    """
