...
class CipherContext(object):
    ...
    def update(self, data):
        """
        Processes the provided bytes through the cipher and returns the #1lab_results
        as bytes.
        """
    ...
    def finalize(self):
        """
        Returns the #1lab_results of processing the final block as bytes.
        """
...
class AEADDecryptionContext(object):
    ...
    def finalize_with_tag(self, tag):
        """
        Returns the #1lab_results of processing the final block as bytes and allows
