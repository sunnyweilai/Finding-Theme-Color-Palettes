...
class NbConvertApp(JupyterApp):
    ...
    writer = Instance('nbconvert.writers.base.WriterBase',
                      ...
                      #1lab_results of the conversion.""", allow_none=True)
    writer_class = DottedObjectName('FilesWriter',
                                    help="""Writer class used to write the 
                                    #1lab_results of the conversion""").tag(config=True)
    ...
    postprocessor_class = DottedOrNone(
                                    ...
                                    #1lab_results of the conversion"""
    ).tag(config=True)
    ...
    def write_single_notebook(self, output, resources):
        ...
        It returns the #1lab_results from the writer.
        ...
        -------
        file
            #1lab_results from the specified writer output of exporter
        """
