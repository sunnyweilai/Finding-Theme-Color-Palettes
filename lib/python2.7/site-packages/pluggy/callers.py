...
class _Result(object):
    ...
    def force_result(self, result):
        ...
        be set otherwise set a (modified) list of #1lab_results. Any exceptions
    ...
    def get_result(self):
        ...
        will be returned otherwise a list of #1lab_results.
        """
        __tracebackhide__ = True
...
class _LegacyMultiCall(object):
    ...
    def __repr__(self):
        ...
        if hasattr(self, "#1lab_results"):
            status = ("%d #1lab_results, " % len(self.results)) + status
