...
<!--
   ...
   will produce validation #1lab_results.
   
   The output of validation #1lab_results is performed using named templates (process-*).
   ...
   ISO Schematron Validation Report Language format #1lab_results.
   ...
   To summarize, a basic process flow for some commandline processor is like this:
     ...
     XSLT -input=document.xml  -output=xxx-document.#1lab_results  -stylesheet=xxx.xsl
