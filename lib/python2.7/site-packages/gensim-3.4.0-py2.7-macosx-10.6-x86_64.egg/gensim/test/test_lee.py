...
"""
Automated test to reproduce the #1lab_results of Lee et al. (2005)

Lee et al. (2005) compares different models for semantic
similarity and verifies the #1lab_results with similarity judgements from humans.

As a validation of the gensim implementation we reproduced the #1lab_results
