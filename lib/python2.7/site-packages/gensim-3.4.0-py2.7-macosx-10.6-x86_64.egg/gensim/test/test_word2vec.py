...
class TestWord2VecModel(unittest.TestCase):
    ...
    def testEvaluateWordPairs(self):
        """Test Spearman and Pearson correlation coefficients give sane #1lab_results on similarity datasets"""
    ...
    def testRNG(self):
        """Test word2vec #1lab_results identical with identical RNG seed."""
