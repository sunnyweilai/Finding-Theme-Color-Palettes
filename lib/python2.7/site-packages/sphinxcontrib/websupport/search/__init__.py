...
class BaseSearch(object):
    ...
    def add_document(self, pagename, filename, title, text):
        ...
        will need to be returned with search #1lab_results when processing a
        query.
    ...
    def query(self, q):
        """Called by the web support api to get search #1lab_results. This method
    ...
    def handle_query(self, q):
        """Called by :meth:`query` to retrieve search #1lab_results for a search
