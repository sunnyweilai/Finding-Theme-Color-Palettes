...
class IMapUnordered(Greenlet):
    """
    At iterator of map #1lab_results.
    """
    ...
    def __init__(self, func, iterable, spawn=None, maxsize=None, _zipped=False):
        ...
        :keyword int maxsize: If given and not-None, specifies the maximum number of
            finished #1lab_results that will be allowed to accumulated awaiting the reader;
            more than that number of #1lab_results will cause map function greenlets to begin
            to block. This is most useful is there is a great disparity in the speed of
            the mapping code and the consumer and the #1lab_results consume a great deal of resources.
...
class GroupMappingMixin(object):
    ...
    def apply_cb(self, func, args=None, kwds=None, callback=None):
        ...
        #1lab_results of *func* (unless an exception was raised.)
    ...
    def apply_async(self, func, args=None, kwds=None, callback=None):
        ...
        .. caution:: The returned greenlet may or may not be tracked
           ...
           not a reliable way to wait for the #1lab_results to be available or
    ...
    def imap(self, func, *iterables, **kwargs):
        ...
        :keyword int maxsize: If given and not-None, specifies the maximum number of
            finished #1lab_results that will be allowed to accumulate awaiting the reader;
            more than that number of #1lab_results will cause map function greenlets to begin
    ...
    def imap_unordered(self, func, *iterables, **kwargs):
        ...
        The same as :meth:`imap` except that the ordering of the #1lab_results
