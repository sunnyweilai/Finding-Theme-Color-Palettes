...
class TestDAGLCA:
    ...
    def test_all_pairs_lowest_common_ancestor3(self):
        """Produces the correct #1lab_results when all pairs given as a generator."""
