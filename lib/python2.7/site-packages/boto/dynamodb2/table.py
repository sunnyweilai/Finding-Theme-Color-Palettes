...
class Table(object):
    ...
    def query(self, limit=None, index=None, reverse=False, consistent=False,
        ...
        **WARNING:** This method is provided **strictly** for
        backward-compatibility. It returns #1lab_results in an incorrect order.
    ...
    def query_2(self, limit=None, index=None, reverse=False,
        ...
        **Note** - You can not query against arbitrary fields within the data
        ...
        #1lab_results in reverse order. (Default: ``False`` - normal order)
        ...
        **per-request**. This is useful in making faster requests & prevent
        ...
        #1lab_results you get back.

        Example::

            # Look for last names equal to "Doe".
            >>> #1lab_results = users.query(last_name__eq='Doe')
    ...
    def query_count(self, index=None, consistent=False, conditional_operator=None,
        ...
        :param scan_index_forward: Specifies ascending (true) or descending
            (false) traversal of the index. DynamoDB returns #1lab_results reflecting
            the requested order determined by the range key. If the data type
            is Number, the #1lab_results are returned in numeric order. For String,
            the #1lab_results are returned in order of ASCII character code values.
    ...
    def scan(self, limit=None, segment=None, total_segments=None,
        ...
        additionally filter the #1lab_results after the table has been read but
        ...
        **per-request**. This is useful in making faster requests & prevent
        ...
        Example::
            ...
            >>> #1lab_results = users.scan(last_name__beginswith='D')
            >>> for res in #1lab_results:
            ...     print res['first_name']
            'Alice'
            'John'
    ...
    def batch_get(self, keys, consistent=False, attributes=None):
        ...
        Example::
            ...
            >>> #1lab_results = users.batch_get(keys=[
            ...     {
            ...         'username': 'johndoe',
            ...     },
            ...     {
