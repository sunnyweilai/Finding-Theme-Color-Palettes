...
class RowProxy(BaseRowProxy):
    ...
    #1lab_results that correspond to constructed SQL expressions).
    """
    __slots__ = ()
...
class ResultProxy(object):
    ...
    def rowcount(self):
        ...
        .. note::
           ...
           * :attr:`.ResultProxy.rowcount` is *only* useful in conjunction
             ...
             number of rows available from the #1lab_results of a SELECT statement
    ...
    def _soft_close(self):
        ...
        fetchXXX() methods will continue to return empty #1lab_results.
...
class BufferedRowResultProxy(ResultProxy):
    ...
    before ``fetchone()`` is called.  This is to allow the #1lab_results of
...
class BufferedColumnResultProxy(ResultProxy):
    ...
    the full grid of #1lab_results is fetched.  This is to operate with
    databases where result rows contain "live" #1lab_results that fall out
