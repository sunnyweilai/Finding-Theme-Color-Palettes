...
class Query(object):
    ...
    def _no_limit_offset(self, meth):
        ...
        if self._limit is not None or self._offset is not None:
            raise sa_exc.InvalidRequestError(
                ...
                "or OFFSET applied. To modify the row-limited #1lab_results of a "
    ...
    def yield_per(self, count):
        ...
        (> 10K rows), to batch #1lab_results in sub-collections and yield them
        ...
        .. warning::
            ...
            which will stream #1lab_results using server side cursors
    ...
    def from_self(self, *entities):
        ...
        first five #1lab_results of the ``User`` query:
    ...
    def distinct(self, *criterion):
        ...
        .. note::
            ...
            :class:`.Query`, however, so would not affect #1lab_results.
    ...
    def all(self):
        """Return the #1lab_results represented by this ``Query`` as a list.

        This #1lab_results in an execution of the underlying query.
    ...
    def from_statement(self, statement):
        """Execute the given SELECT statement and return #1lab_results.
    ...
    def first(self):
        ...
        Calling :meth:`.Query.first` #1lab_results in an execution of the underlying query.
    ...
    def one_or_none(self):
        ...
        Calling :meth:`.Query.one_or_none` #1lab_results in an execution of the
        underlying query.
    ...
    def one(self):
        ...
        Calling :meth:`.one` #1lab_results in an execution of the underlying query.
    ...
    def merge_result(self, iterator, load=True):
        ...
        as this one, return an identical iterator of #1lab_results, with all mapped
        ...
        The structure of the #1lab_results is determined based on the column list of
    ...
    def delete(self, synchronize_session='evaluate'):
        ...
        :param synchronize_session: chooses the strategy for the removal of
            ...
            #1lab_results if they are accessed via get() or already loaded
            collections.
        ...
        .. warning:: **Additional Caveats for bulk query deletes**
            ...
            * The ``'fetch'`` strategy #1lab_results in an additional
    ...
    def update(self, values, synchronize_session='evaluate', update_args=None):
        ...
        :param synchronize_session: chooses the strategy to update the
         attributes on objects in the session. Valid values are:
            ...
            can lead to confusing #1lab_results.
    ...
    def _adjust_for_single_inheritance(self, context):
        ...
        subtypes are selected from the total #1lab_results.
...
class Bundle(InspectionAttr):
    ...
    #1lab_results returned by a column-oriented :class:`.Query` object.  It also
...
class AliasOption(interfaces.MapperOption):
    ...
    def __init__(self, alias):
        ...
        statement that aliases the parent table.  E.g.::
            ...
            # then get #1lab_results via the statement
            #1lab_results = query.from_statement(statement).all()
