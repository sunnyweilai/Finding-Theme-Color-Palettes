...
class Client(Node):
    ...
    Continue using submit or map on #1lab_results to build up larger computations

    >>> c = client.submit(add, a, b)  # doctest: +SKIP

    Gather #1lab_results with the ``gather`` method.
    ...
    def gather(self, futures, errors='raise', maxsize=0, direct=None,
        ...
        Returns
        -------
        #1lab_results: a collection of the same type as the input, but now with
        gathered #1lab_results rather than futures
    ...
    def cancel(self, futures, asynchronous=None, force=False):
        ...
        and all dependent #1lab_results will no longer be accessible
    ...
    def run(self, function, *args, **kwargs):
        ...
        blocks until those #1lab_results come back, and returns the #1lab_results
    ...
    def run_coroutine(self, function, *args, **kwargs):
        ...
        for the coroutine on each worker.  The coroutines' #1lab_results are returned
    ...
    def _optimize_insert_futures(self, dsk, keys):
        ...
        #1lab_results we replace the values of that graph with futures.  This can be
...
class as_completed(object):
    ...
    def batches(self):
        ...
        ...     #1lab_results = client.gather(batch)
        ...     print(#1lab_results)
        [4, 2]
        [1, 3, 7]
        [5]
