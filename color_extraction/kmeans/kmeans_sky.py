...
def quantize(picpath, n_colors):
    ...
    image.save("img/sky/quantized_img/img_quantized%s.png" % n_colors)
    ...
    # plt.show()
    plt.savefig('img/sky/quantized_palette/img_palette%s.png' % n_colors)
...
n_colors_list = [2,3,5,6,10,15,20,25,30]
